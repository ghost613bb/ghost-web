...
describe("storage paths", () => {
  ...
  it("keeps the current album file naming rules", () => {
    expect(buildAlbumCoverFileName("album-created-001", "summer cover.png")).toBe("album-created-001-summer-cover.png");
    expect(buildAlbumPhotoFileName("photo-001", "cat window.png")).toBe("photo-001-cat-window.png");
  });
