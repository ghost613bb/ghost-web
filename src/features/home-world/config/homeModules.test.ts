...
describe("homeModules", () => {
  ...
  it("uses real models for the about cafe, skills greenhouse, todo coffee shop, and message fast food restaurant", () => {
    ...
    expect(homeModules.find((module) => module.id === "thoughts")?.assetKey).toBeUndefined();
